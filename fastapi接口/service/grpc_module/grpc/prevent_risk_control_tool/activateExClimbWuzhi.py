...
class ExClimbWuzhi:
    ...
    async def _get_b3_b4_buvidfp_ticket_Cookie(payload: str, apiExClimbWuzhi: APIExClimbWuzhi = APIExClimbWuzhi(),
        ...
        while retry_time < 2:
            try:  # spi需要cookie :
                # buvid3=6DAF6CBF-97CA-7AFB-C8D2-6089D7EAB95824771infoc;
                # b_nut=1753014324;
                # __at_once=14715989986572521620
        ...
        while retry_time < 2:
            try:
                ...
                headers = {
                    ...
                    # buvid3=6DAF6CBF-97CA-7AFB-C8D2-6089D7EAB95824771infoc; b_nut=1753014324; __at_once=14715989986572521620
