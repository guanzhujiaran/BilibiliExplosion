...
message_type_opt = _descriptor.FieldDescriptor(
  ...
  is_extension=True, extension_scope=None,
  serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key)
MOOO_FIELD_NUMBER = 7663707
mooo = _descriptor.FieldDescriptor(
  name='mooo', full_name='protobuf_unittest.mooo', index=26,
...
_COMPLEXOPTIONTYPE3 = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='moo', full_name='protobuf_unittest.ComplexOptionType3.moo', index=0,
      number=1, type=5, cpp_type=1, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.extensions_by_name['mooo'] = mooo
