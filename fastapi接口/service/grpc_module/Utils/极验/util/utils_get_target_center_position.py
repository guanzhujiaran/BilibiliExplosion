...
from fastapi接口.service.grpc_module.Utils.极验.models.captcha_models import CaptchaInfo, CaptchaResultInfo
from fastapi接口.service.grpc_module.Utils.极验.util.utils_embedding_pic_preprocess import PlugPicPreprocess, PicPreprocessType
from fastapi接口.service.grpc_module.Utils.极验.util.utils_embedding_simularity_gen import PlugSimilarityGen, SimilarityType
