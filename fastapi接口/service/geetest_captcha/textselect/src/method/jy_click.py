...
from fastapi接口.service.geetest_captcha.textselect.src.utils import ver_onnx
from fastapi接口.service.geetest_captcha.textselect.src.utils import yolo_onnx
from fastapi接口.service.geetest_captcha.textselect.src.utils import utils
...
class JYClick(object):
    def __init__(self, per_path='pre_model_v3.bin', yolo_path='best_v2.bin', sign=True):
        ...
        if sign:
            try:
                from fastapi接口.service.geetest_captcha.textselect.src.utils.load import decryption
            except:
