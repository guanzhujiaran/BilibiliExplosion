...
from fastapi接口.service.geetest_captcha.textselect.src.method import jy_click
from fastapi接口.service.geetest_captcha.textselect.src.utils.utils import drow_img
current_path = os.path.dirname(os.path.abspath(__file__))

class TextSelectCaptcha(object):
    def __init__(self, per_path=os.path.join(current_path,'pre_model_v3.bin'), yolo_path='best_v2.bin', sign=True):
