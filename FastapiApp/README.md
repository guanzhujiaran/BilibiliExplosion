...
> \
[__AI判断情感__](FastapiApp/Utils/机器学习/情感分析/情感分析.py)(需要安装redis)\
>> # __可选功能__
> >> [根据日期获取抽奖信息](FastapiApp/service/grpc_module/src/根据日期获取抽奖动态/getLotDynSortByDate.py)\
[根据关键词查询动态](FastapiApp/service/grpc_module/src/获取特殊关键词动态/getKeyWordDynDetail.py)\
[获取别人空间和gitee里面的抽奖](FastapiApp/service/get_others_lot_dyn/get_other_lot_main.py)