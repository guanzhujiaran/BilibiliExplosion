...
class BaseLLM:
    ...
    @property
    def localOpenAi(self) -> ChatOpenAI:
        return ChatOpenAI(
            openai_api_key=CONFIG.local_llm_setting.open_ai_api_key,
            openai_api_base=CONFIG.local_llm_setting.baseurl,
            model_name=CONFIG.local_llm_setting.model_name,
        )
