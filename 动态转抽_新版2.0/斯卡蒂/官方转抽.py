                ...
                if notice:
                    ...
                    if dyn_detail:
                        ...
                        if dyn_detail.get('is_liked') == 1:
                            ...
                            time.sleep(10)
                            continue
                        repostres = self.BAPI.js_repost_non_content_dyn(dyn_detail, dynamic_id, self.uid, self.cookie,
                                                                        self.ua, self.csrf,card_stype)
                        # 用的是新版的转发api
                        if repostres:
...
if __name__ == '__main__':
    a = official_Lottery(3)
    a.seg_time = numpy.linspace(60, 70, 500, endpoint=False)
