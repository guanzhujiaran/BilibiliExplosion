...
class methods:
    ...
    def daily_choujiangxinxipanduan(self, tcontent):  # 动态内容过滤条件
        ...
        matchobj_104 = re.match('.*转发参与', tcontent, re.DOTALL)
...
if __name__=='__main__':
    __test =methods()
    __res=__test.choujiangxinxipanduan("""我身边，快四十岁的未婚中产，至少有10个人。高中时，班里第一名，叫志强。看过《戾气》那期视频的小伙伴，应该还记得，我曾读过一所堪比衡水中学的高中，他就是我那个时候的同学。春节前，我去银行办事，偶遇了志强。一眨眼，20年过去了。我们找了一家餐馆，聊了一个下午。我随口问了一句，你要二胎了没？他尴尬地一笑，说我还没结婚呢，唉，也不想结了！\n告诉了志强，北海先生这个频道，也得到了他的允许，做了一些隐私处理，我把他的故事给大家讲一讲。如果你现在也苦于找对象，看看志强的故事，能否找到自己的影子，能否找到破局之路。\n长视频制作不易，请大家多多点赞支持！我身边，快四十岁的未婚中产，至少有10个人。高中时，班里第一名，叫志强。看过《戾气》那期视频的小伙伴，应该还记得，我曾读过一所堪比衡水中学的高中，他就是我那个时候的同学。春节前，我去银行办事，偶遇了...""")
    print(__res)